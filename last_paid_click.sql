select    tabb.visitor_id, tabb.visit_date, tabb.source as utm_source,
...
from
    (        select distinct on (s.visitor_id) s.visitor_id,
        ...
        s.campaign
    from sessions as s
    where        s.medium = 'cpc' or s.medium = 'cpm'
...
group by tabb.visitor_id, tabb.visit_date, utm_source, utm_medium, utm_campaign,
